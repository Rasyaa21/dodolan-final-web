...
class PromoCodeUserController extends Controller
{
    ...
    public function getPromoCodeByStoreId(string $store_id)
    {
        ...
        return view('pages.frontend.store.promocodes.index', compact(['codes', 'store_id']));
    }
    ...
    {
        return view('pages.frontend.dashboard.promocodes.create');
    }
