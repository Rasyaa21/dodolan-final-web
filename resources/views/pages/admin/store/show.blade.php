            ...
            <div class="mt-3 tab-content">
                ...
                <div class="tab-pane fade show active" id="produk" role="tabpanel" aria-labelledby="home-tab">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.product.create', $store->id) }}" class="btn btn-primary">Tambah
                                Produk</a>
                        </div>
                        <div class="card-body">
                ...
                <div class="tab-pane fade" id="kode-promo" role="tabpanel" aria-labelledby="promo-tab">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.promo.create', request()->route('store')) }}"
                                class="btn btn-primary">Tambah Kode Promo</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-end"> <a
                                                    ...
                                                    <form action="{{ route('admin.promo.destroy', $promoCode->id) }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-outline-danger btn-md"
                ...
                <div class="tab-pane fade" id="transaksi" role="tabpanel" aria-labelledby="transaksi-tab">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4>Transaksi</h4>
                            <a href="{{ route('admin.transaction.create', request()->route('store')) }}"
                                class="btn btn-primary">Tambah Transaksi</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($store->transactions()->orderByDesc('created_at')->get() as $transaction)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="" class="btn btn-outline-primary btn-md">Detail</a>
                                                <a href="{{ route('admin.transaction.resi.show', [$transaction->id, $store->id]) }}"
                                                    class="btn btn-outline-warning btn-md">Edit</a>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="tab-pane fade" id="order" role="tabpanel" aria-labelledby="order-tab">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Daftar order akan muncul di sini.</p>
                        </div>
                    </div>
                </div>
            </div>
