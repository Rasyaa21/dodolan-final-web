...
<section class="section">
    <div class="card" style="margin: 2rem">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('store.dashboard', $code->store_id) }}" class="btn btn-danger">Kembali</a>
        </div>
        <div class="card-body">
            <form action="{{ route('store.codes.update', $code->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
